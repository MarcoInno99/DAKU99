...
export function AppHeader({ teamSlug, email, isAdmin = false }: { teamSlug: string | null; email: string | null; isAdmin?: boolean }) {
  return <header className="app-header">
    ...
    <nav aria-label="Navigazione principale">
      {teamSlug&&<details className="nav-dropdown"><summary>La mia squadra</summary><div><a href="/">La mia società</a><a href="/formazione">Formazione</a><a href="/identita">Stemma squadra</a></div></details>}
