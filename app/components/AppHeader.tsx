export function AppHeader({ teamSlug, email, isAdmin = false }: { teamSlug: string | null; email: string | null; isAdmin?: boolean }) {
  return <header className="app-header">
    ...
    <nav aria-label="Navigazione principale"><a href="/">La mia società</a>{teamSlug && <><a href="/formazione">Formazione</a><a href="/avatar">Avatar</a><a href="/divisa">Divisa 3D</a></>}<a href="/squadre">Club</a><a href="/regolamento">Regole</a>{isAdmin && <a href="/admin">Amministrazione</a>}</nav>
