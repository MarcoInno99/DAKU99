...
export function ClubChoiceViewer({ teamSlug }: { teamSlug: string }) {
  ...
  const rows=[["Direttore Sportivo",choice.sporting_director],["Stadio",choice.stadium],["Centro medico",choice.medical_center],["Settore giovanile",choice.youth_academy],["Centro allenamento",choice.training_center]];
