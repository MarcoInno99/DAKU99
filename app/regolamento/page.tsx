...
const rules = [
  ...
  ["Budget e saldo", "Ogni società parte da 500 crediti. Acquisti, stipendi, scelte societarie, premi e altri movimenti modificano il saldo corrente del club. Se il saldo scende sotto zero, il debito resta visibile fino al recupero."],
  ...
  ["Riporto alla stagione successiva", "A fine stagione il club può portare nel nuovo anno al massimo 75 crediti del saldo positivo. Un saldo negativo non genera riporto e deve essere recuperato secondo le decisioni della lega."],
  ...
  ["Ruolo dell’amministratore", "L’amministratore controlla i blocchi stagionali, può riaprire le scelte, resettare uno sponsor e addebitare le tranche degli stipendi. Le operazioni definitive non possono essere eseguite dagli altri allenatori."],
